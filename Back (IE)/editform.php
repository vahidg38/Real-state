...
<body>
  <div id="snackbar">اطلاعات خانه را با دقت وارد کنید<br> قیمت، متراژ،تعداد خواب ها،تعداد پارکینگ ها باید بصورت عدد صحیح باشند<br>شما میتوانید خانه را حذف کنید</div>
	<hr>
<form action="" method="get">

	<input type="submit" name="submit4" style="background-color: red;cursor: pointer;" value="حذف">
</form>
	<hr>
...
$sql = "UPDATE house SET title='$title', price='$price',type='$type',area='$area',bedrooms='$bedrooms',parkings='$parkings',locality='$locality' WHERE creator='$password' and id='$id' ";
         $result=mysql_query($sql);
