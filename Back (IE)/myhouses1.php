...
<body>
  <div id="snackbar">برای مشاهده صفحه مربوط به هر خانه روی آن کلیک کنید</div>
...
<br><br>
 ...
 <button class="get" action="" style="font-size: 30px;margin-bottom: 10px;" > خانه های بیشتر</button>
 <script>
